...
const Update_Teacher= () => {
  ...
  return (
    <div className='max-w-2xl mx-auto mt-10 p-6 bg-gray-400 shadow-md rounded-lg'>
      <button onClick={() => navigate('/all_teachers')} className='flex items-center gap-2 text-white bg-gray-700 hover:bg-blue-800 px-4 py-2 rounded-md font-semibold transition mb-4'><FaArrowLeft />Back</button>
...
/>
        ...
        <div className='flex justify-between mt-6'>
          ...
          <button
            ...
            className='bg-gray-500 hover:bg-gray-700 text-white px-6 py-2 rounded-md font-semibold transition'
          >
            Cancel
          </button>
        </div>
