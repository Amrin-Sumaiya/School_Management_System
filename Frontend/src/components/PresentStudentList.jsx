// src/components/PresentStudentList.jsx
import React from 'react';

const PresentStudentList = ({ studentList }) => {
  return (
    <div className='bg-green-50 shadow-lg rounded-lg p-3'>
      <h2 className=' text-center font-bold mb-3 text-black'>Today's Present Students</h2>
