 ...
 const [classes, setClasses] = useState([]);
  ...
  useEffect(() => {
    const fetchTeacher = async () => {
      try {
        const res = await axios.get(`https://backend-just.onrender.com/api/teachers/teacher/${id}`);
setTeacher({
  ...res.data,
  ...
  const handleOnSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://backend-just.onrender.com/api/teachers/update/teacher/${id}`, teacher);
